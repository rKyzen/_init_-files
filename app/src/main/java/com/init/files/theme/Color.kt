...
// Dark Theme Colors (Default) - Pure Pitch OLED Black matching Nothing OS & Animation
...
// Light Theme Colors - Pure Pitch White matching Logo-8 and Logo-6 White Animations
...
// Category Semantic Colors (Pure Monochrome Technical Hierarchy)
val CategoryImagesColor = Color(0xFFFFFFFF)
val CategoryVideosColor = Color(0xFFE2E2DC)
val CategoryAudioColor = Color(0xFFCACAC4)
val CategoryDocsColor = Color(0xFFB0B0A8)
val CategoryApksColor = Color(0xFF94948C)
val CategoryArchivesColor = Color(0xFF787870)
val CategoryDownloadsColor = Color(0xFF5C5C56)
val CategoryOtherColor = Color(0xFF40403A)
